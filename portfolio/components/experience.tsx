    ...
    <section id="experience" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-700"> I’m proud to have contributed to impactful projects with, </p>
        </motion.div>
          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              <motion.div
                ...
                variants={fadeIn}
                className={`relative mb-12 md:mb-16 ${index % 2 === 0 ? "md:pr-12 md:text-right md:ml-0 md:mr-auto" : "md:pl-12 md:ml-auto md:mr-0"
